...
(4, 1, NULL, 1, 2, 3, 'KALOLENI', 'KALOLENI', 'PANGANI', NULL, NULL, NULL, NULL, NULL, 'personal', '2022-02-15 18:43:58', '2022-02-15 18:57:10'),
(5, NULL, 4, 11, 54, 67, 'ARRI', 'DUDIYE', 'DUDIYE', NULL, NULL, NULL, NULL, NULL, 'personal', '2022-02-16 03:51:18', NULL);
...
ALTER TABLE `blocks`
  ...
  ADD CONSTRAINT `blocks_ibfk_1` FOREIGN KEY (`ownerID`) REFERENCES `users` (`userID`) ON DELETE CASCADE ON UPDATE CASCADE;
