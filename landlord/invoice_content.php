...
$invoiceValues = $invoice->getInvoiceDatas($bookingID);	
		...
		<td colspan="2" style="font-size:14px">
			...
			foreach($invoiceValues as $invoiceItem){
				...
				<tr>
					...
					Size: <b>'.$blockSize.' Accres </b>
						...
						if($invoiceStatus<>'paid'){ $output .= ' <font color="red">'.$invoiceStatus.'</font>';}else{$output .= ' <font color="green">'.$invoiceStatus.'</font>';}
			...
			$output .= '
				<tr>
					...
					<td align="right" colspan="1" bgcolor="#f2f2f2"></td>
				</tr>
				<tr>
					<td align="right" colspan="4"><b>Sub Total</b></td>
					<td align="right"><b>'.number_format($invoiceDetails['total_rent_before_tax']).'</b></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="right"><b>'.number_format($invoiceDetails['totalRent']).' </b></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="right"><font color="red">  '.number_format($invoiceDetails['totalRent'] - $invoiceDetails['paid']).' </font></td>
				</tr>';
			$output .= '
			</table>
