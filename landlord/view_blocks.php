...
<html lang="en">
    <head>
<title><?php $accesLevel="landlord"; $title ="View Blocks"; echo $accesLevel.' | '.$title;?> </title>
...
$sql = "SELECT * FROM blocks where ownerID='$userID' ";
$result = $db->query($sql);
...
" . "<a href=\"view_invoices.php?blockID=".$blockID."&farmID=".$farmID."  \">
 ...
 <button type='button' class='btn btn-success btn-xs' title='view Invoices for this farm'>
  <i class='fa fa-fw fa-eye' aria-hidden='true'  title='view Invoices for this farm'></i>view Invoices
 </button> 
...
<button type='button' class='btn btn-danger btn-xs' title='Delete this block'>
  <i class='fa fa-fw fa-trash' aria-hidden='true'  title='Delete this block'></i>Delete block
 </button>
