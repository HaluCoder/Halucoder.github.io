...
<title><?php $accesLevel="landlord"; $title ="View not paid Invoices"; echo $accesLevel.' |'.$title;?> </title>
...
$blockID 	= $_GET['blockID'];
	...
	{	
		$sql = "SELECT * FROM invoice_items where ownerID='$userID' AND farmID='$farmID' AND blockID='$blockID' AND status='not paid'";	
	}
		...
		if($userRole == 'landlord')
		{
			$sql = "SELECT * FROM invoice_items where ownerID='$userID' AND status='not paid' ";	
		}
