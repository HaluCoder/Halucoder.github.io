...
$blockID 	= $_GET['blockID'];
	...
	{	
		$sql = "SELECT * FROM invoice_items where ownerID='$userID' AND farmID='$farmID' AND blockID='$blockID' AND status='paid'";	
	}
		...
		if($userRole == 'landlord')
		{
			$sql = "SELECT * FROM invoice_items where ownerID='$userID' AND status='paid' ";	
		}
