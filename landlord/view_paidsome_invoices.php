...
<title><?php $accesLevel="landlord"; $title ="View paid Invoices"; echo $accesLevel.' |'.$title;?> </title>
...
$blockID 	= $_GET['blockID'];
	...
	{	
		$sql = "SELECT * FROM invoice_items where ownerID='$userID' AND farmID='$farmID' AND blockID='$blockID' AND status='paid some'";	
	}
		...
		if($userRole == 'landlord')
		{
			$sql = "SELECT * FROM invoice_items where ownerID='$userID' AND status='paid some' ";	
		}
