...
<title><?php $accesLevel="landlord"; $title ="View Payments"; echo $accesLevel.' |'.$title;?> </title>
...
$sql = "SELECT * FROM payments where farmID='$farmID' AND ownerID='$userID' AND pay_status='received'";
...
" . "<a href=\"add_pay_status.php?u=".$userID."&i=".$invoiceID."&b=".$bookingID."&r=".$blockID."&h=".$farmID."&p=".$payID." \">

 <button type='button' class='btn btn-primary btn-xs' title='Add payment'>
  <i class='fa fa-fw fa-plus' aria-hidden='true'  title='Add payment'></i>Payment
 </button> 
