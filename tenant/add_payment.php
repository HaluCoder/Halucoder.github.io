...
<form method="post"  action="" enctype="multipart/form-data"  >
									...
									<div class="row">
										...
										<div class="col-md-6 col-md-offset-0">
											<div class="form-group">
												<label>Accres</label> 
												<input type="text" class="form-control" value="<?php echo $accres." accres"; ?>" readonly>
											</div>
										</div>
									</div>
									<div class="row">
									...
									<div class="row">			
										<div class="col-md-12 col-md-offset-0">
											<div class="form-group">
												<label>Payment Attachment</label><small> (this attachment will be used to approve your payment)</small>
