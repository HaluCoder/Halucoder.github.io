	...
	<div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                <div class="navbar-header">
                    <a class="navbar-brand" href="tenantHome.php"><img  src="../images/ifmlogo.jpg" alt="logo" class="img" width="auto" height="30px"></a>
                </div>
								...
								<ul class="dropdown-menu dropdown-user">
									...
									<li align="center">
											...
											<?php	
												...
												echo" <img  class='img' src=\"".$profilePicture."\" width='50%' height='50%' alt='image'>";
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="tenantHome.php" class="active"><i class="fa fa-dashboard fa-fw"></i> DASHBOARD</a>
                            </li>
							...
							<li>
                                <a href="#"><i class="fa fa-bank fa-fw"></i> BOOKINGS<span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level">
		
                                    <li>
                                        <a href="view_bookings.php"><i class="fa fa-eye"></i> View Bookings</a>
                                    </li>
