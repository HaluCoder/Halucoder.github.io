...
<html lang="en">
    <head>
<title><?php $accesLevel="tenant"; $title ="View Blocks"; echo $accesLevel.' | '.$title;?> </title>
...
<td> <b>" .$description." </b>. 
Rent now ONLY at <b>Tshs. ".number_format($rent)." </b>per Accre.</td>
...
" . "<a href=\"book_block.php?blockID=".$blockID."&farmID=".$farmID."  \">

 <button type='button' class='btn btn-primary btn-xs' title='Book this block'>
  <i class='fa fa-fw fa-plus' aria-hidden='true'  title='Book this block'></i>Book block
 </button> 
...
<div class='alert alert-info alert-dismissible col-lg-12 col-lg-offset-0'>
 ...
 Sorry!. There are No blocks here.
   </div>
      	</center>";
        }
