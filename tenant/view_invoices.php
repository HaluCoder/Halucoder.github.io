...
$blockID 	= $_GET['blockID'];
	...
	if($userRole == 'admin')
	{
	$sql = "SELECT * FROM invoice_items WHERE farmID='$farmID' AND blockID='$blockID'";
	}
	...
	{
		$sql = "SELECT * FROM invoice_items WHERE farmID='$farmID' AND blockID='$blockID' AND userID='$userID'";	
	}
		...
		else if($userRole == 'landlord')
		{
			...
			$sql = "SELECT * FROM invoice_items WHERE farmID='$farmID' ";	
		}
		else if($userRole == 'tenant')
		{
