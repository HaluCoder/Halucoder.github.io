...
<title><?php $accesLevel="tenant"; $title ="View paidsome Invoices"; echo $accesLevel.' |'.$title;?> </title>
...
$blockID 	= $_GET['blockID'];
	...
	if($userRole == 'admin')
	{
		$sql = "SELECT * FROM invoice_items WHERE farmID='$farmID' AND blockID='$blockID' AND status='paid some' ";
	}
